class Segment{
	...
	private static final double E_1=50; // energie requise pour un mètre de pente unité avec des conditions de base
	private static final double E_0=0.5; // energie requise pour un mètre de pente nulle avec des conditions de base
