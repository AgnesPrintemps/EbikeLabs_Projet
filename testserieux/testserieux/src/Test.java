...
public class Test {
	public static void main(String[] args){
        ...
        if (goodMatchesList.size() >= 7) {
            ...
            System.out.println("Writing images file...");

            Highgui.imwrite("outputImage.jpg", image2);
            
            System.out.println("image file output written");
            
            Highgui.imwrite("matchoutput.jpg", matchoutput);
            
            System.out.println("image file matchoutput written");
            
            Highgui.imwrite("img.jpg", image1);
            
            System.out.println("image 1 written");
